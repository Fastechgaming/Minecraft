...
const I18n = (() => {
  ...
  const DICT = {
    en: {
      ...
      "checkout.cardOption": "Pay by Card",
      "checkout.cardHint": "Pay instantly with Visa/Mastercard (or ABA PAY) via ABA PayWay — no screenshot needed.",
      "checkout.payByCard": "💳 Pay by Card",
      "checkout.orKhqr": "— or scan KHQR below —",
      "checkout.verifyingCard": "Verifying your card payment…",
      "checkout.cardNotCompleted": "We couldn't confirm your card payment — it may still be processing, or it wasn't completed.",
      "checkout.retryCard": "Try again",
      "checkout.useKhqrInstead": "Pay with KHQR instead",
      "checkout.cardVerifyFailed": "Something went wrong verifying your payment ({error}).",
    ...
    km: {
      ...
      "checkout.total": "សរុប",
      "checkout.cardOption": "បង់ដោយកាត",
      "checkout.cardHint": "បង់ភ្លាមៗជាមួយ Visa/Mastercard (ឬ ABA PAY) តាមរយៈ ABA PayWay — មិនចាំបាច់ថតអេក្រង់ទេ។",
      "checkout.payByCard": "💳 បង់ដោយកាត",
      "checkout.orKhqr": "— ឬស្កេន KHQR ខាងក្រោម —",
      "checkout.verifyingCard": "កំពុងផ្ទៀងផ្ទាត់ការបង់ប្រាក់ដោយកាត…",
      "checkout.cardNotCompleted": "យើងមិនអាចបញ្ជាក់ការបង់ប្រាក់ដោយកាតរបស់អ្នកបានទេ — វាអាចនៅកំពុងដំណើរការ ឬមិនទាន់បានបញ្ចប់។",
      "checkout.retryCard": "ព្យាយាមម្តងទៀត",
      "checkout.useKhqrInstead": "បង់ដោយ KHQR វិញ",
      "checkout.cardVerifyFailed": "មានបញ្ហាពេលផ្ទៀងផ្ទាត់ការបង់ប្រាក់របស់អ្នក ({error})។",
      "checkout.backToPayment": "ត្រឡប់ទៅការបង់ប្រាក់",
