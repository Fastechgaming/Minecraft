...
const I18n = (() => {
  ...
  const DICT = {
    en: {
      ...
      "store.cartCheckout": "Checkout",
      "store.cartClear": "Clear cart",
      ...
      "checkout.couponTitle": "Have a coupon?",
      "checkout.couponPlaceholder": "PROMO CODE",
      "checkout.couponApply": "Apply",
      "checkout.couponApplying": "Applying…",
      "checkout.couponApplied": "Coupon {code} applied.",
      "checkout.couponRemove": "Remove",
      "checkout.discount": "Discount",
      "checkout.couponTebexNote": "Coupons can only be used with KHQR payment.",
    ...
    km: {
      ...
      "store.addToCart": "បន្ថែមទៅកន្ត្រក",
      "store.addedToCart": "បានបន្ថែមទៅកន្ត្រក!",
      "store.cart": "កន្ត្រក",
      "store.cartTitle": "កន្ត្រករបស់អ្នក",
      "store.cartEmpty": "កន្ត្រករបស់អ្នកទទេ។",
      "store.cartTotal": "សរុប",
      "store.cartCheckout": "ទូទាត់ប្រាក់",
      "store.cartClear": "សម្អាតកន្ត្រក",
      "store.cartRemove": "លុប",
      ...
      "checkout.items": "ទំនិញ",
      "checkout.total": "សរុប",
      "checkout.couponTitle": "មាន Coupon?",
      "checkout.couponPlaceholder": "កូដ PROMO",
      "checkout.couponApply": "អនុវត្ត",
      "checkout.couponApplying": "កំពុងអនុវត្ត…",
      "checkout.couponApplied": "Coupon {code} បានអនុវត្តរួច។",
      "checkout.couponRemove": "លុប",
      "checkout.discount": "បញ្ចុះតម្លៃ",
      "checkout.couponTebexNote": "Coupon អាចប្រើបានតែជាមួយការទូទាត់ KHQR ប៉ុណ្ណោះ។",
    ...
    zh: {
      ...
      "store.cart": "购物车",
      "store.cartTitle": "您的购物车",
      "store.cartEmpty": "您的购物车是空的。",
      "store.cartTotal": "总计",
      "store.cartCheckout": "结账",
      "store.cartClear": "清空购物车",
      "store.cartRemove": "移除",
      ...
      "checkout.items": "物品",
      "checkout.total": "总计",
      "checkout.couponTitle": "有优惠码吗？",
      "checkout.couponPlaceholder": "优惠码",
      "checkout.couponApply": "使用",
      "checkout.couponApplying": "使用中…",
      "checkout.couponApplied": "优惠码 {code} 已使用。",
      "checkout.couponRemove": "移除",
      "checkout.discount": "折扣",
      "checkout.couponTebexNote": "优惠码仅适用于 KHQR 付款。",
    ...
    vi: {
      ...
      "store.addToCart": "Thêm vào giỏ hàng",
      "store.addedToCart": "Đã thêm vào giỏ hàng!",
      "store.cart": "Giỏ hàng",
      "store.cartTitle": "Giỏ hàng của bạn",
      "store.cartEmpty": "Giỏ hàng của bạn đang trống.",
      "store.cartTotal": "Tổng cộng",
      "store.cartCheckout": "Thanh toán",
      "store.cartClear": "Xóa giỏ hàng",
      ...
      "checkout.items": "Vật phẩm",
      "checkout.total": "Tổng cộng",
      "checkout.couponTitle": "Bạn có mã giảm giá?",
      "checkout.couponPlaceholder": "MÃ GIẢM GIÁ",
      "checkout.couponApply": "Áp dụng",
      "checkout.couponApplying": "Đang áp dụng…",
      "checkout.couponApplied": "Đã áp dụng mã {code}.",
      "checkout.couponRemove": "Xoá",
      "checkout.discount": "Giảm giá",
      "checkout.couponTebexNote": "Mã giảm giá chỉ dùng được với thanh toán KHQR.",
