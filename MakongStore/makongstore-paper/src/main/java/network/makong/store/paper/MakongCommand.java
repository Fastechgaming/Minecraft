...
public final class MakongCommand implements CommandExecutor, TabCompleter {
  ...
  private final MakongStorePlugin plugin;

  public MakongCommand(MakongStorePlugin plugin) {
    this.plugin = plugin;
  }
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    ...
    switch (args[0].toLowerCase()) {
      case "status" -> sender.sendMessage("MakongStore: server id '" + plugin.serverId() + "', " +
