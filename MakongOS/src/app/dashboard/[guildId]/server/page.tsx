...
export default async function ServerPage({ params }: { params: { guildId: string } }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-discord-muted">Feature toggles, staff roles, and logging.</p>
      </div>
      <ServerGeneralForm guildId={params.guildId} initialSettings={settings} roles={roles} textChannels={textChannels} />
    </div>
  );
}
