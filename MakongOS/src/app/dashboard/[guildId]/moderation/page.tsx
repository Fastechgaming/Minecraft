...
import { ModerationForm } from '../../../../components/dashboard/forms/ModerationForm';
...
export default async function ModerationPage({ params }: { params: { guildId: string } }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Automod & Anti-Scam</h1>
        <p className="text-discord-muted">Configure automatic moderation and Gemini Vision anti-scam scanning.</p>
      </div>
      <ModerationForm guildId={params.guildId} initialSettings={settings} roles={roles} textChannels={textChannels} />
    </div>
  );
}
