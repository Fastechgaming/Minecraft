...
public final class Team {
    ...
    private long points,kills,deaths,playtime,stars;
    ...
    public long points(){return points;} public long weeklyPoints(){return points;} public long stars(){return stars;} public long kills(){return kills;} public long deaths(){return deaths;} public long playtime(){return playtime;}
    ...
    public void setStats(long p,long k,long d,long pt){points=p;kills=k;deaths=d;playtime=pt;} public void addStars(long amount){stars=Math.max(0,stars+amount);} public void setStars(long value){stars=Math.max(0,value);} public void addMember(TeamMember m){members.put(m.uuid(),m);} public void removeMember(UUID u){members.remove(u);} public void addAlly(UUID id){allies.add(id);} public void removeAlly(UUID id){allies.remove(id);}
}
