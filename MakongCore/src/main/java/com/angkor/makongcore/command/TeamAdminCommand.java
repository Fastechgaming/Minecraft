...
// exists in exactly one place, not duplicated between the two commands.
public final class TeamAdminCommand implements CommandExecutor, TabCompleter {
    private final MakongCore plugin;
    private final TeamService teams;

    public TeamAdminCommand(MakongCore plugin, TeamService teams) {
        this.plugin = plugin;
        this.teams = teams;
    }
    ...
    // Subcommand names this class understands - AdminCommand checks this
    // before delegating so /makongcore's own global subcommands (reload,
    ...
    private void help(CommandSender s) {
        send(s, """
                <gray><bold>MakongCore Team Admin Commands</bold>
